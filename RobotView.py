...
class RobotView(customtkinter.CTk):
    def __init__(self):
        ...
        self.frame_right.grid_rowconfigure(12, weight=1)
        self.frame_right.grid_rowconfigure(14, weight=1)
        ...
        self.button_a1_decrease.grid(row=0, column=0, padx=10, pady=15, rowspan=2)
        self.button_a2_decrease.grid(row=2, column=0, padx=10, pady=15, rowspan=2)
        self.button_a3_decrease.grid(row=4, column=0, padx=10, pady=15, rowspan=2)
        self.button_a4_decrease.grid(row=6, column=0, padx=10, pady=15, rowspan=2)
        self.button_a5_decrease.grid(row=8, column=0, padx=10, pady=15, rowspan=2)
        self.button_a6_decrease.grid(row=10, column=0, padx=10, pady=15, rowspan=2)
        ...
        self.button_a1_increase.grid(row=0, column=2, padx=10, pady=15, rowspan=2)
        self.button_a2_increase.grid(row=2, column=2, padx=10, pady=15, rowspan=2)
        self.button_a3_increase.grid(row=4, column=2, padx=10, pady=15, rowspan=2)
        self.button_a4_increase.grid(row=6, column=2, padx=10, pady=15, rowspan=2)
        self.button_a5_increase.grid(row=8, column=2, padx=10, pady=15, rowspan=2)
        self.button_a6_increase.grid(row=10, column=2, padx=10, pady=15, rowspan=2)
        ...
        self.label_a1.grid(row=0, column=1, padx=10, pady=0)
        self.label_a2.grid(row=2, column=1, padx=10, pady=0)
        self.label_a3.grid(row=4, column=1, padx=10, pady=0)
        self.label_a4.grid(row=6, column=1, padx=10, pady=0)
        self.label_a5.grid(row=8, column=1, padx=10, pady=0)
        self.label_a6.grid(row=10, column=1, padx=10, pady=0)
        
        
        self.label_a1_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")
        self.label_a2_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")
        self.label_a3_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")
        self.label_a4_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")
        self.label_a5_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")      
        self.label_a6_angle = customtkinter.CTkLabel(self.frame_right, text="0.0")
        self.label_a1_angle.grid(row=1, column=1, padx=10, pady=0)
        self.label_a2_angle.grid(row=3, column=1, padx=10, pady=0)
        self.label_a3_angle.grid(row=5, column=1, padx=10, pady=0)
        self.label_a4_angle.grid(row=7, column=1, padx=10, pady=0)
        self.label_a5_angle.grid(row=9, column=1, padx=10, pady=0)
        self.label_a6_angle.grid(row=11, column=1, padx=10, pady=0)
        ...
        self.button_tool_activate.grid(row=13, column=0, padx=10, pady=20)
        self.button_tool_deactivate.grid(row=13, column=2, padx=10, pady=20)
        self.label_tool.grid(row=13, column=1, padx=10, pady=20)
        ...
        self.label_speed = customtkinter.CTkLabel(self.frame_right, text="Speed")
        self.button_speed_decrease.grid(row=15, column=0, padx=10, pady=20)
        self.button_speed_increase.grid(row=15, column=2, padx=10, pady=20)
        self.label_speed.grid(row=15, column=1, padx=10, pady=20)
